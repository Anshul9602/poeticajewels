          ...
          <div class="tab-content">
              ...
              <div class="tab-content">
                <?php foreach ($languages as $language) { ?>
                  <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                    ...
                    <div class="form-group">
                      <label class="col-sm-2 control-label" for="input-meta-description<?php echo $language['language_id']; ?>">Fine Details</label>
                      <div class="col-sm-10">
                        <textarea name="product_description[<?php echo $language['language_id']; ?>][meta_description]" rows="5" placeholder="<?php echo $entry_meta_description; ?>" id="input-meta-description<?php echo $language['language_id']; ?>" class="form-control summernote"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['meta_description'] : ''; ?></textarea>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-2 control-label" for="input-meta-keyword<?php echo $language['language_id']; ?>">Washcare</label>
                      <div class="col-sm-10">
            ...
            <div class="tab-pane" id="tab-data">
              <div class="form-group">
                ...
                <div class="col-sm-4">
                  <input type="text" name="ean" value="<?php echo $ean; ?>" placeholder="Sub Heading" id="input-ean" class="form-control" />
                </div>
              </div>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-location">Color</label>
                <div class="col-sm-4">
                  <input type="text" name="location" value="<?php echo $location; ?>" placeholder="Color" id="input-location" class="form-control" />
                </div>
                <label class="col-sm-2 control-label" for="input-isbn">Fabric</label>
                <div class="col-sm-4">
                  <input type="text" name="isbn" value="<?php echo $isbn; ?>" placeholder="Fabric" id="input-isbn" class="form-control" />
                </div>
              </div>
              <div class="form-group">
              ...
              <div style="display: none;" class="form-group">
                ...
                <div class="col-sm-3">
                  <div class="input-group date">
                    <input type="text" name="date_available" value="2021-04-17" placeholder="<?php echo $entry_date_available; ?>" data-date-format="YYYY-MM-DD" id="input-date-available" class="form-control" />
            ...
            <div class="tab-pane" style="display: none;" id="tab-discount">
              <div class="table-responsive">
            ...
            <div class="tab-pane" style="display: none;" id="tab-reward">
              <div class="form-group">
    ...
    -->
				...
				<script type="text/javascript">
					$(document).ready(function() {
						var html = '&nbsp;&nbsp;<button type="button" onclick="addMultipleImages(this);" data-toggle="tooltip" title="Add multiple images" class="btn btn-success"><i class="fa fa-list"></i></button>';
						html += '<input type="hidden" id="elfinder_multiple" value=""/>';
						$('button[onclick^="addImage("]').after(html);
					});
					...
					function addMultipleImages(btn) {
						...
						if (getURLVar('user_token')) {
							var user_token = '&user_token=' + getURLVar('user_token');
						} else {
							var user_token = '&token=' + getURLVar('token');
						}

						$.ajax({
						  url: 'index.php?route=common/filemanager' + user_token + '&multiple=callbackMultipleImages&target=elfinder_multiple&thumb=placeholder',
						  dataType: 'html',
						  beforeSend: function() {
					...
					function callbackMultipleImages(data={}) {
						if (!data) return;
						...
						for (idx in data) {
							if (data[idx].mime) {
								...
								var curr_image_row = image_row;
								addImage();

								$('#thumb-image' + curr_image_row + ' img').attr('src', file.tmb).css('max-width', '100%');
								$('#input-image' + curr_image_row + '').val(file.path);
								$('input[name="product_image[' + curr_image_row + '][sort_order]"]').val(curr_image_row);
							}
						}
					}
				</script>
