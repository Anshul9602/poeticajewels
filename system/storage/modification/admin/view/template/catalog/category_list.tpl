          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              <thead>
							...
							<tr>
								<td colspan="4">
								 <input type="text"  style="width: 36%; display: inline-block;" name="filter_name" value="<?php echo $filter_name; ?>"  id="input-name" class="form-control" />
								 <button type="button" id="button-filter" class="btn btn-primary button" style="margin-top: -4px;"><i class="fa fa-filter"></i> <?php echo $button_filter; ?></button>
								 <button type="button" id="button-clear" style="margin-top: -4px;" class="btn btn-danger button"><?php echo $button_clear; ?></button>
							   </td>
                            </tr>
						  <!-- admin category filter-->
...
<script type="text/javascript"><!--
 ...
 location ='index.php?route=catalog/category&token=<?php echo $token; ?>';
});						
// Category
