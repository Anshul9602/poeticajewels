<?php
$_['text_panel_title']    = 'Facebook Conversion API + Facebook Pixel + Dynamic Ads';
...
$_['entry_evcd_help'] = '<font style="font-size: 10px;">Optional - help you to view live events tracking</font>';