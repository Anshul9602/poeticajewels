...
<div id="content">
  <script>
    $(document).ready(function() {
      $(".fa-download").parent().css('display', 'none');
    })
  </script>
        ...
        <div class="well">
          <div class="row">
            ...
            <div class="col-sm-4">
              ...
              <div class="form-group">
                <label class="control-label" for="input-category">Category Name</label>
                <input type="text" name="filter_category" value="<?php echo $filter_category; ?>" placeholder="Category Name" id="input-category" class="form-control" />
              </div>
            </div>
            <div class="col-sm-4">
              <div class="form-group">
  ...
  <script type="text/javascript">
    ...
    $('#button-filter').on('click', function() {
      ...
      //category filter add later by ronak
