...
class ControllerExtensionPaymentPayu extends Controller {
    ...
    public function index() {
		...
		$data['Pg'] = 'CC';
		$data['surl'] = HTTPS_SERVER.'/index.php?route=extension/payment/payu/callback';
		$data['Furl'] = HTTPS_SERVER.'/index.php?route=extension/payment/payu/callback';
	...
	public function callback() {
        ...
        ($this->request->post['key'] == $this->config->get('payu_merchant'))) {
			$this->language->load('extension/payment/payu');
